...
const form = useForm({
    ...
    locale: 'en',
    is_admin: false,
    application_files_enabled: false,
    personal_files_enabled: false,
    excel_import_enabled: false,
    job_alerts_tier: 'none',
});
...
<template>
    <Head :title="t('app.administration.users_create_title')" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">
                {{ t('app.administration.users_create_title') }}
            </h2>
        </template>
